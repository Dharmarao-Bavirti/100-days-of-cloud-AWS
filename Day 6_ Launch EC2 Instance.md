...
6. Under Key pair (login), for Key pair name, choose an existing key pair or choose Create new key pair to create your first key pair. **For this task, create a new RSA key pair named `nautilus-kp`.**
